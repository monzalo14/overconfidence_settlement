...
\begin{frame}{Main Result}
  ...
  \hskip-6.0cm\begin{table}
    ...
    \tiny{\input{\folder/minicortes_monthstreatment.tex}}
\end{table}
    \footnotesize
    \textit{Notes:} 
...
\begin{frame}{Summary Statistics}{Outcomes}
  \begin{table}[H]
    ...
    \begin{center}
       \tiny{\input{\folder/SS_outcomes.tex}}
    \end{center}
\end{table}
\end{frame}
...
\begin{frame}{Summary Statistics}{Strategic variables}
  \begin{table}[H]
    ...
    \begin{center}
       \tiny{\input{\folder/SS_strategic.tex}}
    \end{center}
\end{table}
\end{frame}
...
\begin{table}[H]
    ...
    \begin{center}
       \scriptsize{\input{\folder/SS_A.tex}}
    \end{center}
\end{table}
    \footnotesize    
    \textit{Notes:} 
