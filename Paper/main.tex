...
\begin{center}
\scriptsize{\input{./Tables/update_reg_theta.tex}}
\end{center}
 \footnotesize
...
\label{Table_determinants_updating}
\begin{center}
\scriptsize{\input{./Tables/update_reg_rel.tex}}
\end{center}
 \footnotesize
\textit{Notes:} 
\emph{Mistreated} variable refers to the survey question: "How well do you think you were treated by the firm?". The omitted category is "Very Good", while 1, 2 and 3 refer to "Fairly Well", "Not so well" and "Not well at all".
...
\begin{table}[H]
    \caption{Direct Updating}
     \begin{center}
       \scriptsize{\input{./Tables/direct_updating.tex}}
    \end{center}
           \footnotesize    
  \textit{Notes:} 
...
\begin{figure}[H]
    \caption{Out of sample fit for duration predictions - Pilot calculator}
...
\begin{figure}[H]
    \caption{Out of sample fit for compensation predictions - Pilot calculator}
    \label{}
    \begin{center}
    \begin{subfigure}{0.49\textwidth}
    \centering
