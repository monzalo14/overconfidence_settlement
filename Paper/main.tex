...
\begin{table}[H]
\caption{Determinants of updating}
...
\begin{table}[H]
    ...
    \begin{subtable}{1\textwidth}
      \centering
        \caption{Scale Up}
        \scriptsize{\input{./Tables/Compliance_2.tex}}
    \end{subtable}
           \footnotesize
           \\
           \\
...
\begin{table}[H]
    ...
    \begin{subtable}{1\textwidth}
      \centering
        \caption{Scale Up}
        \scriptsize{\input{./Tables/balance_2.tex}}
    \end{subtable}
           \footnotesize 
           \\
           \\
...
\begin{figure}[H]
    ...
    \centering
     ...
     \end{subfigure}
        ...
        {\footnotesize \textit{RScript: }  \texttt{covariate\_plots.R}}
\end{figure}
