...
%    \end{subfigure}
    \begin{subfigure}{\textwidth}
        ...
        \centering
        \includegraphics[width=\textwidth]{updatebeleif_amount_1.pdf}
    \end{subfigure}
    
        \begin{subfigure}{\textwidth}
        \caption{Update in beliefs in amount (Scale Up)}
        \centering
        \includegraphics[width=\textwidth, height=0.25\textheight]{updatebeleif_amount_2.pdf}
    \end{subfigure}
...
\begin{table}[H]
    ...
    \begin{subtable}{.5\linewidth}
      \centering
        \caption{Pilot}
        \scriptsize{\input{./Tables/update_beleif_1.tex}}
    \end{subtable}%
    \begin{subtable}{.5\linewidth}
      \centering
        \caption{Scale Up}
        \scriptsize{\input{./Tables/update_beleif_2.tex}}
    \end{subtable} 
           \footnotesize    
  \textit{Notes:} 
    Summary statistics of parties' update in beliefs; measured as $\frac{exit-initial}{initial}$, for both \emph{Pilot} and \emph{Scale Up}.
...
\begin{table}[H]
    ...
    \begin{center}
        \scriptsize{\input{./Tables/Reg_con_oc_theta.tex}}
    \end{center}
    \footnotesize
    \textit{Notes:} 
...
\begin{table}[H]
    ...
    \label{Con_update}
    \begin{center}
        \scriptsize{\input{./Tables/con_vs_update.tex}}
    \end{center}
    \footnotesize
    \textit{Notes:} 
...
\begin{table}[H]
    ...
    \label{ITT_ATT}
    \begin{center}
    \scriptsize{\input{./Tables/ITT_ATT.tex}}
    \end{center}
    \footnotesize
    \textit{Notes:} 
...
\begin{figure}[H]
    ...
    \begin{center}
    \begin{subfigure}{\textwidth}
        \caption{Update in beliefs in amount (Pilot) }
        \centering
        \includegraphics[width=\textwidth]{updatebeleif_amount_total_1.pdf}
    \end{subfigure}
    
        \begin{subfigure}{\textwidth}
        \caption{Update in beliefs in amount (Scale Up) }
        \centering
        \includegraphics[width=\textwidth, height=0.25\textheight]{updatebeleif_amount_total_2.pdf}
    \end{subfigure}
    \end{center}
