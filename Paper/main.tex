...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.49\textwidth}
    \centering
        \includegraphics[width=1\textwidth]{oos_fit_liqtotal.tiff}
     \end{subfigure}
     
        \begin{subfigure}{0.49\textwidth}    
         \centering
        \includegraphics[width=1\textwidth]{oos_fit_duracion.tiff}
     \end{subfigure}
     
     \begin{subfigure}{0.49\textwidth}
    \centering
        \includegraphics[width=1\textwidth]{oss_fit_categorical.tiff}
     \end{subfigure}
