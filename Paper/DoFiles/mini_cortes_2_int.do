...
rename tratamientoquelestoco treatment
	...
	*Same day conciliation
	...
	qui su seconcilio if treatment!=0
	...
	*Interaction public lawyer
	eststo: reg seconcilio i.treatment##i.abogado_pub if treatment!=0, robust
	estadd scalar Erre=e(r2)
	qui su seconcilio if treatment!=0
	estadd scalar DepVarMean=r(mean)
	qui su abogado_pub if treatment!=0
...
foreach corte in june july aug sept oct {
	...
	*Simple regression
	...
	estadd scalar Erre=e(r2)
	qui su convenio_`corte' if treatment!=0
	estadd scalar DepVarMean=r(mean)
	qui  test 1.treatment=3.treatment
	estadd scalar Pvalue=r(p)
	qui testparm i(2/3).treatment
	...
	*Interaction public lawyer
	eststo: reg convenio_june i.treatment##i.abogado_pub if treatment!=0, robust
	estadd scalar Erre=e(r2)
	...
	*****************************
	eststo: reg convenio_oct i.treatment##i.abogado_pub if treatment!=0, robust
	estadd scalar Erre=e(r2)
...
estadd scalar Pvalue_=r(p)
	...
	*************************
	esttab using "$directorio\Results\Results_3\Regressions\treatment_reg_minicortes_2_int.csv", se star(* 0.1 ** 0.05 *** 0.01)  ///
