...
*Amount won on log
replace dineromasprob=1 if dineromasprob==0
replace dineromasprob=log(dineromasprob)
*Total asked in log
...
********************************************************************************
esttab using "$directorio\Results\Results_3\Regressions\Reg1_expectation_log.csv", se star(* 0.1 ** 0.05 *** 0.01)  ///
