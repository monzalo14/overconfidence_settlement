...
*Treatment
gen treatment=dummy_calculadora_partes
...
qui su update_comp_a if e(sample)
estadd scalar mean=r(mean)
eststo: reg convenio i.treatment##c.update_comp_a , robust cluster(fecha_lista) 
estadd scalar Erre=e(r2)
qui su update_comp_a if e(sample)
estadd scalar mean=r(mean)
...
qui su update_comp_ra if e(sample)
estadd scalar mean=r(mean)
eststo: reg convenio i.treatment##c.update_comp_ra , robust cluster(fecha_lista) 
estadd scalar Erre=e(r2)
qui su update_comp_ra if e(sample)
estadd scalar mean=r(mean)
...
qui su update_comp_rd if e(sample)
estadd scalar mean=r(mean)
eststo: reg convenio i.treatment##c.update_comp_rd , robust cluster(fecha_lista) 
estadd scalar Erre=e(r2)
qui su update_comp_rd if e(sample)
estadd scalar mean=r(mean)

esttab using "$sharelatex\Tables\reg_results\con_vs_update.csv", se star(* 0.1 ** 0.05 *** 0.01)  ///
