...
rename tratamientoquelestoco treatment
	...
	*Interaction public lawyer
	eststo: reg seconcilio i.treatment##i.abogado_pub##i.p_actor if treatment!=0, robust
	estadd scalar Erre=e(r2)
	qui su seconcilio if treatment!=0
	estadd scalar DepVarMean=r(mean)
	qui  test 1.treatment=3.treatment
...
foreach corte in june july aug sept oct {
	...
	*Simple regression
	eststo: reg convenio_`corte'  i.treatment##i.abogado_pub##i.p_actor if treatment!=0, robust
	estadd scalar Erre=e(r2)
