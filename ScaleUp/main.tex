...
\begin{center}
\scriptsize{\input{\folder/presence.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/presence_t.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/SS_survey.tex}}
\end{center}


\begin{center}
\scriptsize{\input{\folder/TAB_survey.tex}}
\end{center}


\begin{center}
\scriptsize{\input{\folder/NA.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/update_beleif.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/ttest.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/tab_calc.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/Take_up.tex}}
\end{center}
...
\begin{center}
\scriptsize{\input{\folder/Simple_regression.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Notification_actor.tex}}
\end{center}
\end{table}

\begin{table}[H]\centering \caption{\emph{Calculadora demandado}}
\begin{center}
\scriptsize{\input{\folder/Notification_dem.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Presence_employee.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Num_litigios.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Update_beleifs_prob.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Update_beleifs_pago.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/Conciliator.tex}}
\end{center}
\end{table}

\begin{table}[H]\centering \caption{Interaction term}
\begin{center}
\scriptsize{\input{\folder/Interaction_Conciliator.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/SS_control_survey.tex}}
\end{center}
\end{table}

\begin{table}[H]\centering \caption{Controlling for some answers in employee survey}
\begin{center}
\scriptsize{\input{\folder/Answers_employee.tex}}
\end{center}
\end{table}
...
\begin{center}
\scriptsize{\input{\folder/iniciales.tex}}
\end{center}

\begin{table}[H]\centering \caption{Controlling for some initial variables}
\begin{center}
\scriptsize{\input{\folder/Control_iniciales.tex}}
\end{center}
\end{table}
