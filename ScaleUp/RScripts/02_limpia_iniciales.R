...
# limpiamos fechas.
df <- read.csv('../Raw/bases_iniciales.csv', as.is = T) %>%
...
#saveRDS(df,"../calculadora/clean_data/experimento_martes_18.rds")
#write.csv(df,"../calculadora/clean_dataexperimento_martes_18.csv")

saveRDS(df, '../DB/bases_iniciales.RDS')
write.csv(df, '../DB/bases_iniciales.csv', na="")
